...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Forgot password | Arsip Laporan PKL dan KKN</title>
  ...
  <body class="animsition page-forgot-password layout-full">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        ...
        <form method="post" role="form" action="{{ route('reset_password') }}">
          @csrf
          <div class="form-group">
            <input type="password" class="form-control" id="" name="password" placeholder="New Password">
          </div>
          <div class="form-group">
            <input type="password" class="form-control" id="" name="confirmpassword" placeholder="Confirm New Password">
          </div>
          <div class="form-group">
            <button type="submit" class="btn btn-primary btn-block">Resest Password</button>
            <input type="text" class="form-control" id="" name="kode" placeholder="New Password" value="{{ request()->kode }}" hidden>
            <input type="text" class="form-control" id="" name="email" placeholder="New Password" value="{{ request()->email }}" hidden>
          </div>
        </form>
