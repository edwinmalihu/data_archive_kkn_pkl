  ...
  <body class="animsition page-login layout-full page-dark">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
      <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        ...
        <div>
          <h2 style="color:white">Selamat Datang di Website Pengarsipan Laporan</h2>
        </div>

        <div>
            <a href="/daftar-laporan" class="btn btn-primary"><i class="icon wb-chevron-left"></i> Daftar Laporan</a>
            <a href="/login" class="btn btn-primary">Log in <i class="icon wb-chevron-right"></i></a>   
        </div>
